...
document.addEventListener("keydown", (e)=>{
    if (e.code === keys[currentKeyIndex]) PNotify.success({
        title: "Right key!",
        delay: 500
    });
    else PNotify.error({
...
const salesChart = new (0, _autoDefault.default)(ctx, {
    type: 'line',
    data: chartData
});

},{"@pnotify/core/dist/BrightTheme.css":"grIyt","chart.js/auto":"d8NN9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"grIyt":[function() {},{}],"d8NN9":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
